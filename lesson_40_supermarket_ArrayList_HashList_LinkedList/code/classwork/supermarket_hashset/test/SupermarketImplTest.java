package classwork.supermarket_hashset.test;

import classwork.supermarket_hashset.dao.Supermarket;
import classwork.supermarket_hashset.dao.SupermarketImpl;
...
class SupermarketImplTest
{
    ...
    void findByCategory()
    {
        ...
        //productsIterable.forEach(actual::add);
    ...
    {
        Iterable<Product> actual = supermarket.findProductWithExpiredDay();
